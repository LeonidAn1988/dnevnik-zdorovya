...
const suites = [
  ...
  ['Одно вещество в двух коробках', await import('./duplicates.test.mjs')],
  ['Молчание в чужом дневнике', await import('./silence.test.mjs')],
  ...
  ['Единицы измерения по форме выпуска', await import('./units.test.mjs')],
